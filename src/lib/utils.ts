...
export const initialMessages: Message[] = [
  {
    ...
    id: "0",
    content:
    "Hey there! I'm your AI Assistant. 😊 My primary role is to assist judges in enhancing judicial efficiency. I can automate the process of searching for legal precedents, drafting sentences, and improving overall citizen satisfaction with the justice system. If you have a specific question about your PDF on Catalan Law or need assistance with anything else, feel free to ask!",
  },
];
